...
@interface PullToRefreshTableView : UITableView{
    ...
    id<TablePullUpEvent> _delegate_PullUp;
    id<TablePullDownEvent> _delegate_PullDown;
    
//    __weak id<TablePullUpEvent> _delegate_PullUp;
//    __weak id<TablePullDownEvent> _delegate_PullDown;
    
    NSInteger _times;
}

@property (nonatomic, strong) StateView * headerView;
@property (nonatomic, strong) StateView * footerView;

@property (weak) id<TablePullUpEvent> delegate_PullUp;
@property (weak) id<TablePullDownEvent> delegate_PullDown;
